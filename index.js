...
server.post("/fb_campaign", async (req,res)=>{
...
//             [Campaign.Fields.name]: 'Promo Name', // Each object contains a fields map with a list of fields supported on that object.
...
// ];
// params = {
//   'name' : 'JoyUP Test Ad set ',
//   'daily_budget' : '2000',
//   'campaign_id' : id,
//   'bid_amount' : '20',
//   'billing_event' : 'IMPRESSIONS',
//   'optimization_goal' : 'IMPRESSIONS',
//   'targeting' : {'age_min':20,'age_max':65,'behaviors':[],'genders':[1],'geo_locations':{'countries':['US'],}},
//   'status' : 'PAUSED',
//   "device_platforms ": [ 
//     "all "
//   ]
...
const filePath ='https://joyup-images-1.s3.amazonaws.com/5ef52e857bb3265a0d964a09/1611335605690_ozburegr-bogo.png';
let content = (filePath).toString('base64')
const imageHash = await account.createAdImage(
    [],
    {
        image_url:filePath
    }
